<?php 
    ...
    $profeuno = substr(strip_tags($_POST['profe-01']), 0, 255);
    $profedos = substr(strip_tags($_POST['profe-02']), 0, 255);
    $profetres = substr(strip_tags($_POST['profe-03']), 0, 255);

    $body = "Nuevo pedido de Clases Armadas<br>"."<br>Nombre: " . $username . "<br>Celular: " . $cel . "<br>Email: " . $email . "<br>" . $profeuno . "<br>" . $profedos . "<br>" . $profetres; 
